 ...
 * @author coralise
 */
public abstract class SqlAbstractCommand implements CommandExecutor, TabCompleter{
    ...
    SqlAbstractCommand(String cmd, String p, boolean c){
    ...
    public static void registerCommands(JavaPlugin p){
        ...
        new SqlBanCommand();
        new SqlUnbanCommand();
        new SqlHistoryCommand();
        new SqlKickCommand();
        new SqlIPBanCommand();
        new SqlMuteCommand();
        new SqlUnmuteCommand();
        new SqlWarnCommand();
