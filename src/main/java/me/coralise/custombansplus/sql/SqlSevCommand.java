 ...
 * @author wayne
 */
public class SqlSevCommand extends SqlAbstractCommand{
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args){
        ...
        if(args.length == 0){
            ...
            if(sender.hasPermission("custombansplus.admin")){
                SqlCBMenu.openSevsAdminGUI((Player) sender);
            }else{
                SqlCBMenu.openSevsListGUI((Player) sender);
            }
            return true;
        }
        check = false;
